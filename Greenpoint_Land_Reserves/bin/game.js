    ...
    function(t, e, n) {
      ...
      var x,
        O = (function(t) {
          ...
          return r(e, t), s([y.readonly], e.prototype, 'src', void 0), (e = s([p.DisposableComponent('engine.shape', a.GLTF_SHAPE)], e))
        })(y)
      ;(e.GLTFShape = O),
        (function(t) {
      ...
      var w = (function(t) {
        ...
        return (
          r(e, t),
          s([y.readonly], e.prototype, 'src', void 0),
          s([y.readonly], e.prototype, 'style', void 0),
      ...
      var I = (function(t) {
        function e() {
          var e = (null !== t && t.apply(this, arguments)) || this
          return (e.alphaTest = 0.5), (e.transparencyMode = P.AUTO), e
        }
        return (
          r(e, t),
      ...
      var V = (function(t) {
        function e(e, n) {
          var o = t.call(this) || this
          if (((o.volume = 1), (o.playbackRate = 1), (o.loop = !1), (o.seek = -1), (o.playing = !1), !(e instanceof N)))
            ...
            (t.LookRotation = function(e, n) {
              ...
              if (h > v) {
                var x = Math.sqrt(1 + h - p - v),
                  O = 0.5 / x
                return (b.x = (c + u) * O), (b.y = 0.5 * x), (b.z = (y + d) * O), (b.w = (f - l) * O), b
              }
        ...
        a = (function() {
          ...
          return (
            ...
            (t.prototype.multiplyToArray = function(t, e, n) {
              ...
              return (
                (e[n] = i * C + s * T + a * P + p * M),
                (e[n + 1] = i * x + s * R + a * S + p * F),
                (e[n + 2] = i * O + s * A + a * I + p * D),
                (e[n + 3] = i * w + s * E + a * z + p * L),
                (e[n + 4] = u * C + l * T + c * P + h * M),
                (e[n + 5] = u * x + l * R + c * S + h * F),
                (e[n + 6] = u * O + l * A + c * I + h * D),
                (e[n + 7] = u * w + l * E + c * z + h * L),
                (e[n + 8] = d * C + f * T + y * P + v * M),
                (e[n + 9] = d * x + f * R + y * S + v * F),
                (e[n + 10] = d * O + f * A + y * I + v * D),
                (e[n + 11] = d * w + f * E + y * z + v * L),
                (e[n + 12] = m * C + b * T + g * P + _ * M),
                (e[n + 13] = m * x + b * R + g * S + _ * F),
                (e[n + 14] = m * O + b * A + g * I + _ * D),
                (e[n + 15] = m * w + b * E + g * z + _ * L),
                this
              )
            }),
            (t.prototype.equals = function(t) {
        ...
        c = (function() {
          function t(t) {
            ;(this.eventManager = new a.EventManager()),
              ...
              (this.rootEntity = t),
              (this.playerEntity = new l.Entity()),
              (this.playerEntity.uuid = 'PlayerEntityReference'),
              this.addEntity(this.playerEntity),
              (this.avatarEntity = new l.Entity()),
              (this.avatarEntity.uuid = 'AvatarPositionEntityReference'),
